package com.prplsd.kajianku.data;
...
import com.prplsd.kajianku.DashboardActivity;
import com.prplsd.kajianku.auth.LoginActivity;
...
public class Session {
    ...
    Context _context;
    int PRIVATE_MODE = 0;
    private static final String PREF_NAME = "KajianKu";
