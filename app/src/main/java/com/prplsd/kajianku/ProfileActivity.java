...
import com.prplsd.kajianku.auth.ChangePasswordActivity;
import com.prplsd.kajianku.data.Constant;
import com.prplsd.kajianku.data.Session;
import com.prplsd.kajianku.model.LoginResponse;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    public void loadItem() {
        ...
        progressDialog.show();
        AndroidNetworking.get(Constant.GET_PROFIL_USER + "/" + session.getUserId())
                .build()
